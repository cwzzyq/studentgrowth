...
<div class="caption">
        ...
        <center>
	<div id="middle"><h3>当前管理的班级名称<?php echo ($data1['ClassName']); ?></h3>
...
<table width="90%" border="1" id="table-4">
	...
	<tr>
		<td> <?php if(is_array($data3)): $i = 0; $__LIST__ = $data3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>编号:<?php echo ($vo["ID"]); ?>姓名：<?php echo ($vo["XingMing"]); ?> 评价内容:<?php echo ($vo["Comment"]); ?>录入时间：<?php echo ($vo["LuRuShiJian"]); ?><br><?php endforeach; endif; else: echo "" ;endif; ?>
		<td>
	</tr> 
</table>
...
<table width="90%" border="1" id="table-4">
  <tr>
	...
	<td><a href="__APP__/Teacher/CommentsModi/StudentID/<?php echo ($vo["StudentID"]); ?>" class="btn btn-success" role="button">评价</a></td>
